...
public class PlayerController : MonoBehaviour
{
    ...
    public Slider woodprogressSlider;
    ...
    void Start()
    {
        ...
        woodProgressBar = GameObject.FindGameObjectWithTag("WoodProgressBar");
        woodprogressSlider = woodProgressBar.GetComponent<Slider>();
        woodprogressSlider.value = 0.0f;
    }
